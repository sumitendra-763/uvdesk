 ...
 */
final class Version20200124053416 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE uv_thread (id INT AUTO_INCREMENT NOT NULL, ticket_id INT DEFAULT NULL, user_id INT DEFAULT NULL, source VARCHAR(191) NOT NULL, message_id LONGTEXT DEFAULT NULL, thread_type VARCHAR(191) NOT NULL, created_by VARCHAR(191) NOT NULL, cc LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', bcc LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', reply_to LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', delivery_status VARCHAR(255) DEFAULT NULL, is_locked TINYINT(1) DEFAULT \'0\' NOT NULL, is_bookmarked TINYINT(1) DEFAULT \'0\' NOT NULL, message LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, agent_viewed_at DATETIME DEFAULT NULL, customer_viewed_at DATETIME DEFAULT NULL, INDEX IDX_637D7E5D700047D2 (ticket_id), INDEX IDX_637D7E5DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_prepared_responses (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT \'public\', actions LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', status TINYINT(1) DEFAULT \'1\', date_added DATETIME NOT NULL, date_updated DATETIME NOT NULL, INDEX IDX_8AB5F066A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE uv_article (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, meta_description VARCHAR(255) DEFAULT NULL, keywords VARCHAR(255) DEFAULT NULL, viewed INT DEFAULT NULL, status INT DEFAULT 0, date_added DATETIME NOT NULL, date_updated DATETIME NOT NULL, stared INT DEFAULT NULL, meta_title VARCHAR(255) DEFAULT NULL, INDEX search_idx (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
