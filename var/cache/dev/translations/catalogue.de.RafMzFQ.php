...
$catalogue = new MessageCatalogue('de', array (
  ...
  array (
    ...
    'Ticket Requests' => 'Ticket-Anfragen',
    'Cookie Usage Policy' => 'Cookie-Nutzungsrichtlinie',
    'cookie' => 'Plätzchen',
    'cookies' => 'Kekse',
    'HELP' => 'HILFE',
    'Home' => 'Zuhause',
    ...
    'Prev' => 'Zurück',
    'Ticket query message' => 'Ticketabfragenachricht',
    'Select type' => 'Art auswählen',
    'Search KnowledgeBase' => 'Wissensdatenbank durchsuchen',
    'You can\'t merge an account with itself.' => 'Sie können ein Konto nicht mit sich selbst zusammenführen.',
    'Edit Profile' => 'Profil bearbeiten',
    'Customer Login' => 'Kundenlogin',
    'Contact Us' => 'Kontaktiere uns',
    'If you\'ve ever contacted our support previously, your account would have already been created.' => 'Wenn Sie schon einmal Kontakt mit unserem Support aufgenommen haben, wurde Ihr Konto bereits erstellt.',
    'support' => 'Unterstützung',
    'HelpDesk' => 'Beratungsstelle',
    ...
    'Unable to find an answer?' => 'Können Sie keine Antwort finden?',
    ...
    'Forgot Password' => 'Passwort vergessen',
    'Enter your email address and we will send you an email with instructions to update your login credentials.' => 'Ingrese su dirección de correo electrónico y le enviaremos un correo electrónico con instructcciones para actualizar sus credenciales de inicio de sesión.',
    ...
    'Time' => 'Eingeloggt als',
    'Links' => 'Dein Profil',
    'Broadcast Message' => 'Ticket erstellen',
    'Wide Logo' => 'Agent erstellen',
    'Upload an Image (200px x 48px) in</br> PNG or JPG Format' => 'Kunden erstellen',
    'It will be shown as Logo on Knowledgebase and Helpdesk' => 'Ausloggen',
    'Website Status' => 'Apps',
    'Enable front end website and knowledgebase for customer(s)' => 'Integrieren Sie Apps nach Ihren Wünschen, um die Dinge schneller als je zuvor zu erledigen.',
    'Brand Color' => 'Apps erkunden',
    'Page Background Color' => 'Form Builder',
    'Header Background Color' => 'Wissensbasis',
    'Banner Background Color' => 'Knowledgebase ist eine Quelle starrer und komplexer Informationen, die den Kunden hilft, sich selbst zu helfen.',
    'Page Link Color' => 'Artikel',
    'Page Link Hover Color' => 'Kategorien',
    'Article Text Color' => 'Ordner',
    'Tag Line' => 'ORDNER',
    'Hi! how can we help?' => 'Produktivität',
    'Layout' => 'Automatisieren Sie Ihre Prozesse, indem Sie eine Reihe von Regeln und Vorgaben erstellen, um schneller auf die Tickets zu reagieren.',
    'Ticket Create Option' => 'Vorbereitete Antworten',
    'Login Required To Create Tickets' => 'Gespeicherte Antworten',
    'Remove Customer Login/Signin Button' => 'Tickettypen',
    'Disable Customer Login' => 'Arbeitsabläufe',
    'Meta Description (Recommended)' => 'die Einstellungen',
    'Meta Keywords (Recommended)' => 'Verwalten Sie Ihre Markenidentität, Unternehmensinformationen und andere Details auf einen Blick',
    'Header Link' => 'Branding',
    'URL (with http:// or https://)' => 'Benutzerdefinierte Felder',
    'Footer Link' => 'Email Einstellungen',
    'Custom CSS (Optional)' => 'E-Mail-Vorlagen',
    'It will be add to the frontend knowledgebase only' => 'Briefkasten',
    'Custom Javascript (Optional)' => 'Spam-Einstellungen',
    'Broadcast message content to show on helpdesk' => 'Swift Mailer',
    'From' => 'Stichworte',
    'Time duration between which message will be displayed(if applicable)' => 'Benutzer',
    'Broadcasting Status' => 'Kontrollieren Sie Ihre Gruppen, Teams, Agenten und Kunden',
    'Broadcasting is Active' => 'Agenten',
    'Choose a default company\'s timezone' => 'Kunden',
    'Date Time Format' => 'Gruppen',
    'Choose a format to convert date to specified date time format' => 'Privilegien',
    'An empty file is not allowed.' => 'Mannschaften',
    'File size must not be greater than 200KB !!' => 'Anwendungen',
    'Please upload valid Image file (Only JPEG, JPG, PNG allowed)!!' => 'ECommerce Order Syncronization',
    'Provide a valid url(with protocol)' => 'Importieren Sie E-Commerce-Bestelldetails von verschiedenen verfügbaren Plattformen in Ihre Support-Tickets.',
  ),
));
