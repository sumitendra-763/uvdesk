...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'Article Text Color' => 'Couleur du texte de l\'article',
    'Tag Line' => 'Tag line',
    'Hi! how can we help?' => 'Salut! Comment pouvons-nous vous aider?',
    'Layout' => 'Disposition',
    'Ticket Create Option' => 'Option de création de ticket',
    'Login Required To Create Tickets' => 'Connexion requise pour créer des billets',
    ...
    'From' => 'De',
    'Time duration between which message will be displayed(if applicable)' => 'Durée entre laquelle le message sera affiché (le cas échéant)',
    'Broadcasting Status' => 'Statut de diffusion',
    'Broadcasting is Active' => 'La radiodiffusion est active',
    'Choose a default company\'s timezone' => 'Choisir le fuseau horaire d\'une entreprise par défaut',
