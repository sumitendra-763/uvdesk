...
class __TwigTemplate_6eb48a986acf87accbd9c7df7d3d15b29ef4823ee59f0ffd46e9a1844ba481b4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
        ...
        echo "                    <div class=\"uv-dropdown sort\">
                        <div class=\"uv-dropdown-btn uv-vertical-align uv-margin-right-5\">Sort By: Id</div>
...
\t\t\t\t\t<input type=\"text\" class=\"uv-search-inline uv-vertical-align uv-margin-right-15\" placeholder=\"Search\">
\t\t\t\t</div>
            </div>
...
\t\t\t\t\t\t\t";
        ...
        if (((isset($context["articlesEnabled"]) || array_key_exists("articlesEnabled", $context)) && ((isset($context["articlesEnabled"]) || array_key_exists("articlesEnabled", $context) ? $context["articlesEnabled"] : (function () { throw new RuntimeError('Variable "articlesEnabled" does not exist.', 64, $this->source); })()) == true))) {
            // line 65
            echo "\t\t\t\t\t\t\t\t<th>Total Article(s)</th>
\t\t\t\t\t\t\t";
        }
        // line 67
        echo "                            <th class=\"uv-last\">Action</th>
                        </tr>
                    </thead>
...
";
    ...
    {
        return array (  499 => 300,  495 => 299,  479 => 286,  442 => 252,  400 => 213,  340 => 156,  321 => 141,  317 => 139,  313 => 137,  311 => 136,  306 => 135,  295 => 127,  289 => 125,  287 => 124,  280 => 120,  276 => 119,  267 => 113,  264 => 112,  253 => 103,  242 => 95,  231 => 87,  226 => 84,  220 => 81,  210 => 80,  189 => 67,  185 => 65,  183 => 64,  175 => 58,  157 => 41,  153 => 38,  145 => 34,  140 => 32,  137 => 31,  134 => 30,  131 => 29,  128 => 27,  118 => 26,  90 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
...
\t</script>
{% endblock %}
", "@UVDeskCoreFramework/supportTagList.html.twig", "/home/users/sanjeev.papnoi/www/html/UVDeskOSZIp/uvdesk-community-v1.0.6/vendor/uvdesk/core-framework/Resources/views/supportTagList.html.twig");
    }
}
