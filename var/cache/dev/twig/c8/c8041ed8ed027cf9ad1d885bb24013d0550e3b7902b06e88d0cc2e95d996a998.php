...
class __TwigTemplate_cff631ef56a316767586dbe8b565902094a33ab77df1eed1dcd8152826885470 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
    ...
    ";
        ...
        // line 52
        echo "    ";
        if (((isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context)) && twig_get_attribute($this->env, $this->source, ($context["websiteConfiguration"] ?? null), "articleTextColor", [], "any", true, true, false, 52))) {
            // line 53
...
<div class=\"uv-header\">
    <div class=\"uv-container\">
        ...
        if (((isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context)) &&  !twig_test_empty(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context) ? $context["websiteConfiguration"] : (function () { throw new RuntimeError('Variable "websiteConfiguration" does not exist.', 69, $this->source); })()), "website", [], "any", false, false, false, 69), "logo", [], "any", false, false, false, 69)))) {
            // line 70
            echo "                        <img src=\"";
            echo twig_escape_filter($this->env, (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 70, $this->source); })()), "request", [], "any", false, false, false, 70), "scheme", [], "any", false, false, false, 70) . "://") . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 70, $this->source); })()), "request", [], "any", false, false, false, 70), "httpHost", [], "any", false, false, false, 70)) . $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("")), "html", null, true);
        ...
        echo "                </a>
            ...
            <div class=\"uv-header-rt\">
                ";
        // line 88
        if ((isset($context["currentUser"]) || array_key_exists("currentUser", $context) ? $context["currentUser"] : (function () { throw new RuntimeError('Variable "currentUser" does not exist.', 88, $this->source); })())) {
            // line 89
            echo "                    <span style=\"position: relative\" class=\"uv-profile-block\">
                        <div class=\"uv-profile-wrapper uv-dropdown-other\">
                            <div class=\"uv-profile-avatar\">
                                <img src=\"";
            // line 92
            echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, (isset($context["currentUser"]) || array_key_exists("currentUser", $context) ? $context["currentUser"] : (function () { throw new RuntimeError('Variable "currentUser" does not exist.', 92, $this->source); })()), "smallThumbnail", [], "any", false, false, false, 92)) ? (((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 92, $this->source); })()), "request", [], "any", false, false, false, 92), "scheme", [], "any", false, false, false, 92) . "://") . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 92, $this->source); })()), "request", [], "any", false, false, false, 92), "httpHost", [], "any", false, false, false, 92)) . $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("")) . twig_get_attribute($this->env, $this->source, (isset($context["currentUser"]) || array_key_exists("currentUser", $context) ? $context["currentUser"] : (function () { throw new RuntimeError('Variable "currentUser" does not exist.', 92, $this->source); })()), "smallThumbnail", [], "any", false, false, false, 92))) : ($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((isset($context["default_customer_image_path"]) || array_key_exists("default_customer_image_path", $context) ? $context["default_customer_image_path"] : (function () { throw new RuntimeError('Variable "default_customer_image_path" does not exist.', 92, $this->source); })())))), "html", null, true);
            echo "\">                       
                            </div>
            ...
            // line 96
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["currentUser"]) || array_key_exists("currentUser", $context) ? $context["currentUser"] : (function () { throw new RuntimeError('Variable "currentUser" does not exist.', 96, $this->source); })()), "firstName", [], "any", false, false, false, 96), "html", null, true);
            echo "</span>
                            </div>
            ...
            echo "</a>
                                    ...
                                    ";
            // line 107
            if ((twig_get_attribute($this->env, $this->source, (isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context) ? $context["websiteConfiguration"] : (function () { throw new RuntimeError('Variable "websiteConfiguration" does not exist.', 107, $this->source); })()), "ticketCreateOption", [], "any", false, false, false, 107) == 1)) {
                // line 108
                echo "                                        <li>
                                            <a href=\"";
                // line 109
            ...
            if (((isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context)) && twig_get_attribute($this->env, $this->source, (isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context) ? $context["websiteConfiguration"] : (function () { throw new RuntimeError('Variable "websiteConfiguration" does not exist.', 130, $this->source); })()), "ticketCreateOption", [], "any", false, false, false, 130))) {
                // line 131
                echo "                                ";
                if (( !twig_get_attribute($this->env, $this->source, (isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context) ? $context["websiteConfiguration"] : (function () { throw new RuntimeError('Variable "websiteConfiguration" does not exist.', 131, $this->source); })()), "loginRequiredToCreate", [], "any", false, false, false, 131) || twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 131, $this->source); })()), "user", [], "any", false, false, false, 131))) {
                    // line 132
                    echo "                                    <li><a href=\"";
                    echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("helpdesk_customer_create_ticket");
            ...
            echo "
                            ";
            // line 136
            if (((isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context)) && twig_get_attribute($this->env, $this->source, ($context["websiteConfiguration"] ?? null), "removeCustomerLoginButton", [], "any", true, true, false, 136))) {
                // line 137
                echo "                                ";
                if ( !twig_get_attribute($this->env, $this->source, (isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context) ? $context["websiteConfiguration"] : (function () { throw new RuntimeError('Variable "websiteConfiguration" does not exist.', 137, $this->source); })()), "removeCustomerLoginButton", [], "any", false, false, false, 137)) {
                    // line 138
                    echo "                                    <li><a href=\"";
...
";
        // line 158
        if (((isset($context["searchDisable"]) || array_key_exists("searchDisable", $context)) && ((isset($context["searchDisable"]) || array_key_exists("searchDisable", $context) ? $context["searchDisable"] : (function () { throw new RuntimeError('Variable "searchDisable" does not exist.', 158, $this->source); })()) == false))) {
            // line 159
            ...
            <div class=\"uv-container\">
                <article>
                    <h1>
                        ";
            // line 165
            if (((isset($context["websiteConfiguration"]) || array_key_exists("websiteConfiguration", $context)) && twig_get_attribute($this->env, $this->source, ($context["websiteConfiguration"] ?? null), "siteDescription", [], "any", true, true, false, 165))) {
                // line 166
                echo "                            ";
...
";
    ...
    {
        return array (  375 => 171,  372 => 170,  369 => 169,  366 => 168,  360 => 166,  358 => 165,  348 => 159,  346 => 158,  339 => 153,  325 => 141,  321 => 139,  313 => 138,  310 => 137,  308 => 136,  305 => 135,  302 => 134,  294 => 132,  291 => 131,  289 => 130,  286 => 129,  275 => 127,  271 => 126,  265 => 125,  261 => 123,  249 => 116,  241 => 113,  238 => 112,  230 => 109,  227 => 108,  225 => 107,  218 => 105,  212 => 102,  203 => 96,  199 => 95,  193 => 92,  188 => 89,  186 => 88,  181 => 85,  166 => 72,  157 => 70,  155 => 69,  151 => 68,  141 => 60,  135 => 57,  129 => 54,  126 => 53,  123 => 52,  117 => 49,  114 => 48,  111 => 47,  105 => 44,  102 => 43,  99 => 42,  93 => 39,  87 => 36,  81 => 33,  78 => 32,  76 => 31,  45 => 2,  43 => 1,);
    }
...
{% endif %}
", "@UVDeskSupportCenter/Templates/header.html.twig", "/home/users/sanjeev.papnoi/www/html/UVDeskOSZIp/uvdesk-community-v1.0.6/vendor/uvdesk/support-center-bundle/Resources/views/Templates/header.html.twig");
    }
}
