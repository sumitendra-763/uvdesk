...
class __TwigTemplate_bd88ae8ab0b2fa32c19191543c31f06f5f223b14ef699fcc48534802cad86cb7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"uv-navbar\">
    ...
    <div class=\"uv-actions\">
        ...
        echo "\" class='profiler'>Your Profile</a></li>
                    </ul>

                    <ul>
                        ";
        // line 330
        if (twig_get_attribute($this->env, $this->source, (isset($context["user_service"]) || array_key_exists("user_service", $context) ? $context["user_service"] : (function () { throw new RuntimeError('Variable "user_service" does not exist.', 330, $this->source); })()), "isAccessAuthorized", [0 => "ROLE_AGENT_CREATE_TICKET"], "method", false, false, false, 330)) {
            // line 331
            echo "                            <li data-action=\"create\" class=\"uv-open-popup\" data-target=\"create-ticket-modal\">Create Ticket</li>
                        ";
        }
        // line 333
        echo "\t\t\t\t\t\t";
        if (twig_get_attribute($this->env, $this->source, (isset($context["user_service"]) || array_key_exists("user_service", $context) ? $context["user_service"] : (function () { throw new RuntimeError('Variable "user_service" does not exist.', 333, $this->source); })()), "isAccessAuthorized", [0 => "ROLE_AGENT_MANAGE_AGENT"], "method", false, false, false, 333)) {
            // line 334
            echo "                            <li><a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("helpdesk_member_create_account");
            echo "\">Create Agent</a></li>
                        ";
        }
        // line 336
        echo "\t\t\t\t\t\t";
        if (twig_get_attribute($this->env, $this->source, (isset($context["user_service"]) || array_key_exists("user_service", $context) ? $context["user_service"] : (function () { throw new RuntimeError('Variable "user_service" does not exist.', 336, $this->source); })()), "isAccessAuthorized", [0 => "ROLE_AGENT_MANAGE_CUSTOMER"], "method", false, false, false, 336)) {
            // line 337
            echo "                            <li><a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("helpdesk_member_create_customer_account");
            echo "\">Create Customer</a></li>
                        ";
        }
        // line 339
        echo "
    ...
    \$(function () {
        ...
        var SidePanelUV = Backbone.View.extend({
            ...
            initialize : function() {
                ...
                var asideView = '";
        // line 417
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 417, $this->source); })()), "request", [], "any", false, false, false, 417), "cookies", [], "any", false, false, false, 417), "get", [0 => "uv-asideView"], "method", false, false, false, 417), "html", null, true);
        echo "';
                if(asideView == 'true')
                    this.toggleAsideBar();
            },
...
";
        // line 453
        if (twig_get_attribute($this->env, $this->source, (isset($context["user_service"]) || array_key_exists("user_service", $context) ? $context["user_service"] : (function () { throw new RuntimeError('Variable "user_service" does not exist.', 453, $this->source); })()), "isAccessAuthorized", [0 => "ROLE_AGENT_CREATE_TICKET"], "method", false, false, false, 453)) {
            // line 454
            echo "    ";
            echo twig_get_attribute($this->env, $this->source, (isset($context["ticket_service"]) || array_key_exists("ticket_service", $context) ? $context["ticket_service"] : (function () { throw new RuntimeError('Variable "ticket_service" does not exist.', 454, $this->source); })()), "appendTwigSnippet", [0 => "createMemberTicket"], "method", false, false, false, 454);
            echo "
    ";
        }
    ...
    {
        return array (  550 => 454,  548 => 453,  510 => 417,  446 => 356,  428 => 341,  424 => 339,  418 => 337,  415 => 336,  409 => 334,  406 => 333,  402 => 331,  400 => 330,  393 => 326,  384 => 322,  376 => 316,  370 => 314,  363 => 312,  361 => 311,  352 => 305,  342 => 300,  327 => 287,  43 => 1,);
    }
...
\t\t\t\t\t\t{% if user_service.isAccessAuthorized('ROLE_AGENT_MANAGE_CUSTOMER') %}
                            <li><a href=\"{{ path('helpdesk_member_create_customer_account') }}\">Create Customer</a></li>
                        {% endif %}
...
{% endif %}
", "@UVDeskCoreFramework/Templates/header.html.twig", "/home/users/sanjeev.papnoi/www/html/UVDeskOSZIp/uvdesk-community-v1.0.6/vendor/uvdesk/core-framework/Resources/views/Templates/header.html.twig");
    }
}
