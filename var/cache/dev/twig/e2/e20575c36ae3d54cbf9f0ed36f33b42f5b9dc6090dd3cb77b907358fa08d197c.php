...
class __TwigTemplate_6d570a4621764505cb46f3d27552084d8f5cfd82dbfc3542dc74cfe1847cc21e extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if ((isset($context["groups"]) || array_key_exists("groups", $context) ? $context["groups"] : (function () { throw new RuntimeError('Variable "groups" does not exist.', 194, $this->source); })())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                ...
                echo ">
                                                ...
                                                <span class=\"uv-checkbox-label\">";
                // line 203
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["group"], "name", [], "any", false, false, false, 203), "html", null, true);
                echo "</span>
                                            </label>
                                        </div>
                                        <!-- /// -->
...
\t</script>
{% endblock %}
", "@UVDeskCoreFramework/Agents/updateSupportAgent.html.twig", "/home/users/sanjeev.papnoi/www/html/UVDeskOSZIp/uvdesk-community-v1.0.6/vendor/uvdesk/core-framework/Resources/views/Agents/updateSupportAgent.html.twig");
    }
}
