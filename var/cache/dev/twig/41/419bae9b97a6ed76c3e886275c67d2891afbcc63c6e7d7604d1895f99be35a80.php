...
class __TwigTemplate_0bdfd61127183df1d5cd1338cb7b1524e6e597948d477cf0884fffb24adc20d7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
        // line 106
        echo twig_escape_filter($this->env, (((twig_get_attribute($this->env, $this->source, (isset($context["solution"]) || array_key_exists("solution", $context) ? $context["solution"] : (function () { throw new RuntimeError('Variable "solution" does not exist.', 106, $this->source); })()), "visibility", [], "any", false, false, false, 106) == "public")) ? ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Published")) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Draft"))), "html", null, true);
        echo "
\t\t\t\t\t\t\t</span>
...
\t\t});
\t</script>
{% endblock %}", "@UVDeskSupportCenter/Staff/Articles/articleListBySolution.html.twig", "/home/users/sanjeev.papnoi/www/html/UVDeskOSZIp/uvdesk-community-v1.0.6/vendor/uvdesk/support-center-bundle/Resources/views/Staff/Articles/articleListBySolution.html.twig");
    }
}
