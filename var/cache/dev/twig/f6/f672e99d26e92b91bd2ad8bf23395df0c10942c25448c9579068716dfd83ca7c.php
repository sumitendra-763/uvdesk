...
class __TwigTemplate_f47166851e58a5dcdc4fbbca35038f9677267c9d958f429c800fd68244e5f692 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<input type=\"text\" class=\"uv-search-inline uv-search-inline-full\" placeholder=\"Search Tickets\">
\t\t\t</div>
\t\t</div>
\t</div>
\t<!--//Action Bar-->
...
\t\t\t\t<%  if(agent) { %>
        ...
        // line 151
        echo twig_escape_filter($this->env, (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 151, $this->source); })()), "request", [], "any", false, false, false, 151), "scheme", [], "any", false, false, false, 151) . "://") . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 151, $this->source); })()), "request", [], "any", false, false, false, 151), "httpHost", [], "any", false, false, false, 151)) . $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("")), "html", null, true);
...
";
    ...
    {
        return array (  627 => 309,  623 => 308,  558 => 248,  554 => 247,  538 => 234,  476 => 175,  463 => 165,  452 => 157,  445 => 153,  440 => 151,  433 => 147,  425 => 142,  417 => 137,  409 => 132,  401 => 127,  387 => 116,  375 => 107,  366 => 102,  356 => 101,  337 => 90,  333 => 89,  329 => 88,  325 => 87,  321 => 86,  302 => 69,  291 => 67,  287 => 66,  283 => 65,  278 => 63,  269 => 59,  255 => 48,  246 => 44,  236 => 37,  227 => 30,  217 => 29,  201 => 23,  197 => 22,  192 => 19,  184 => 17,  182 => 16,  176 => 15,  170 => 11,  160 => 10,  141 => 8,  122 => 7,  103 => 6,  84 => 5,  65 => 4,  42 => 1,);
    }
...
\t</script>
{% endblock %}
", "@UVDeskSupportCenter/Knowledgebase/ticketList.html.twig", "/home/users/sanjeev.papnoi/www/html/UVDeskOSZIp/uvdesk-community-v1.0.6/vendor/uvdesk/support-center-bundle/Resources/views/Knowledgebase/ticketList.html.twig");
    }
}
