...
class __TwigTemplate_bde2bdc6c8708bbabdb5c44a87bc231fa7903b8d2cc1cf29d68774eeab014c23 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        // line 40
        if (((isset($context["feedbacks"]) || array_key_exists("feedbacks", $context)) && (twig_get_attribute($this->env, $this->source, (isset($context["feedbacks"]) || array_key_exists("feedbacks", $context) ? $context["feedbacks"] : (function () { throw new RuntimeError('Variable "feedbacks" does not exist.', 40, $this->source); })()), "enabled", [], "any", false, false, false, 40) == true))) {
            // line 41
...
\t\t\t\t\t\t";
            // line 99
            if (((isset($context["feedbacks"]) || array_key_exists("feedbacks", $context)) &&  !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["feedbacks"]) || array_key_exists("feedbacks", $context) ? $context["feedbacks"] : (function () { throw new RuntimeError('Variable "feedbacks" does not exist.', 99, $this->source); })()), "article", [], "any", false, false, false, 99)))) {
                // line 100
                echo "\t\t\t\t\t\t\tthis.feedbacks = ";
...
\t";
    ...
    {
        return array (  375 => 113,  362 => 102,  356 => 100,  354 => 99,  334 => 81,  331 => 80,  325 => 77,  315 => 76,  303 => 73,  300 => 72,  298 => 71,  294 => 69,  291 => 47,  287 => 45,  283 => 43,  281 => 42,  278 => 41,  276 => 40,  268 => 34,  260 => 31,  254 => 30,  250 => 28,  244 => 26,  238 => 24,  236 => 23,  233 => 22,  231 => 21,  226 => 19,  218 => 18,  213 => 15,  203 => 14,  184 => 12,  165 => 11,  146 => 10,  127 => 9,  108 => 8,  89 => 5,  70 => 4,  59 => 1,  56 => 3,  43 => 1,);
    }
...
\t{% endif %}
{% endblock %}
", "@UVDeskSupportCenter/Knowledgebase/article.html.twig", "/home/users/sanjeev.papnoi/www/html/UVDeskOSZIp/uvdesk-community-v1.0.6/vendor/uvdesk/support-center-bundle/Resources/views/Knowledgebase/article.html.twig");
    }
}
